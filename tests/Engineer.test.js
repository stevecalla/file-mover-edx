...
describe("Engineer", () => {
    ...
    it("should create an object keys first name, last name, full name, id, email role", () => {
      const engineer = new Engineer("Sarah", "Jones", 5, "sjones@gmail.com", "sjones");
      engineer.getRole();

      expect(engineer).toEqual({ firstName: "Sarah", lastName: "Jones", fullName: "", id: 5, email: "sjones@gmail.com", role: "Engineer", gitHubUserName: "sjones"});
    });
