...
describe("Manager", () => {
    it("should should be an instance of manager class", () => {
    ...
    it("should create an object keys first name, last name, full name, id, email role", () => {
      ...
      expect(manager).toEqual({ firstName: "Sarah", lastName: "Jones", fullName: "", id: 5, email: "sjones@gmail.com", role: "Manager", officeNumber: 5});
    });
