...
describe("Intern", () => {
    ...
    it("should create an object keys first name, last name, full name, id, email role", () => {
      const intern = new Intern("Sarah", "Jones", 5, "sjones@gmail.com", "Oxford");
      intern.getRole();

      expect(intern).toEqual({ firstName: "Sarah", lastName: "Jones", fullName: "", id: 5, email: "sjones@gmail.com", role: "Intern", internSchool: "Oxford"});
    });
